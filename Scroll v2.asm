...
//set up irq
    ...
    setSpriteXY:
        ...
        sta $d01b       // all except 0 behind
        jsr PutCharInSprite7    //put first char of our text into sprite 7
         ldx #80
         lda #$a0
     nextText:        
         sta $0400+(0*40),x     //fill bottom 2 lines with inverse space to hide any overrun of colour bars
...
scrolltext:     // chars above 127 trigger effects on /off  128/9 = bounce off/on, 192 + x = colour, 224/5 = Sprite 0 on /off 226/7 hidden line with colour bars on/off
        .text "OldSkoolCoder"
        .byte extraTextOn
        .text " gave us homework. A text scroller he said... "
        .byte bounce_on
